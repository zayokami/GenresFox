...
const I18n = (function () {
    ...
    const _fallbackMessages = {
        ...
        "de": {
            ...
            "aboutDescription": "Eine vollständig quelloffene, minimalistische und hoch anpassbare Erweiterung für neue Registerkarten.",
        ...
        "ru": {
            ...
            "aboutDescription": "Полностью открытое, минималистичное и высоко настраиваемое расширение для новых вкладок.",
